...
int main(int argc, char* argv[])
{
	...
	// 파일 크기를 섹터 크기인 512byte로 맞추기 위해 나머지 부분을 0x00으로 채움
	...
	// 부트섹터의 5 번째 byte부터 커널에 대한 정보를 넣음
...
// 현재 위치부터 512byte 배수 위치까지 맞추어 0x00으로 채움
int AdjustInSectorSize( int iFd, int iSourceSize )
{
	int i;
...
void WriteKernelInformation( int iTargetFd, int iKernelSectorCount)
{
	...
	// 파일의 시작에서 5byte 떨어진 위치가 커널의 총 섹터 수 정보를 나타냄
